...
const MagicButton = ({
  ...
  return (
    <button className="relative inline-flex h-12 w-full sm:2/5 md:w-fit lg:w-3/8 overflow-hidden rounded-lg p-[1px] focus:outline-none  md:mt-10">
      <span className="absolute inset-[-1000%] animate-[spin_3s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#1F042B_0%,#725bab_50%,#cdcbff_100%)]" />
